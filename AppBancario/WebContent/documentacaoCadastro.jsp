		...
		<form action="DocumentacaoController" method="post">
			<div class="form-group">
				<label for="rg">RG:</label> <input type="text" class="form-control"
					id="rg" placeholder="Digite nesse formato: xx.xxx.xxx-x" name="rg">
			</div>
			<div class="form-group">
				<label for="cpf">CPF:</label> <input type="text"
					class="form-control" id="cpf"
					placeholder="Digite nesse formato: xxx.xxx.xxx-xx" name="cpf">
			</div>
			<div class="form-group">
				<label for="endereco">Endereço:</label> <input type="text"
					class="form-control" id="endereco:"
					placeholder="Logradouro, número, complemento" name="endereco">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label for="telefone">Telefone:</label> <input type="text"
					...
					placeholder="Entre com o valor do contra-cheque" name="telefone">
			</div>
